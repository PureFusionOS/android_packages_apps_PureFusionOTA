...
<xsl:stylesheet xmlns:exsl="http://exslt.org/common"
    xmlns:xsl="http://www.w3.org/1999/XSL/Transform" extension-element-prefixes="exsl" version="1.0">
    ...
    <xsl:template match="test-run">
        <table>
            <tr>
                <td>
                    <xsl:message>Writing runner document
