...
class Action:
    ...
    def actualize(self):
        ...
        self.engine_.add_dependency(actual_targets,
        ...
        self.manager_.engine().set_update_action(self.action_name_, actual_targets,
                                                 self.actual_sources_,
                                                 properties)
...
class Subvariant:
    def __init__(self, main_target, prop_set, sources, build_properties, sources_usage_requirements,
                 created_targets):
        """
