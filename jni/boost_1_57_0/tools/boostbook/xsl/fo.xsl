<?xml version="1.0" encoding="utf-8"?><!-- Copyright 2003 Douglas Gregor --><!-- Distributed under the Boost Software License, Version 1.0. --><!-- (See accompanying file LICENSE_1_0.txt or http://www.boost.org/LICENSE_1_0.txt) -->
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <fo:block>
                            ...
                            <xsl:text>.
                            </xsl:text> <!-- FIXME: Hack!!! This should be in the locale! -->
                        </fo:block>
                    </xsl:otherwise>
                </xsl:choose>
            </fo:list-item-label>
