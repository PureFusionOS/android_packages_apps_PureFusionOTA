...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:import href="http://docbook.sourceforge.net/release/xsl/current/html/math.xsl" />

    <!-- Bring in the fast chunking overrides.  There's nothing
         that we need to override, so include instead of importing it. -->
    <xsl:include href="http://docbook.sourceforge.net/release/xsl/current/html/chunkfast.xsl" />
